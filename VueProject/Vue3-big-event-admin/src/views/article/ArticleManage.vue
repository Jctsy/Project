...
const onSizeChange = (size) => {
    ...
    // 只要是每页条数变化了 那么原来正在访问的当前页意义就不大了 数据大概率已经不再原来那一个页
    // 更新从第一个渲染即可
...
// 搜索逻辑 => 按照最新的条件 重新检索 从第一个开始展示
const onSearch = () => {
    params.value.pagenum = 1 // 重置页面
    getArticleList()
}

// 重置逻辑 => 将筛选条件清空 重新检索 从第一条开始展示
const onReset = () => {
    params.value.pagenum = 1 // 重置页面
    ...
    <page-container title="文章管理">
        ...
        <el-form inline>
            ...
            <el-form-item label="发布状态">
                ...
                <el-select v-model="params.state" style="width: 220px">
        ...
        <el-table :data="articleList" v-loading = "loading">
            ...
            <el-table-column width="180" label="发表时间" prop="pub_data">
                <template #default="{ row }">
                    {{ formatTime(row.pub_date) }}
                </template>
            </el-table-column>
            <el-table-column label="状态" prop="state"></el-table-column>
            <!-- 利用作用域插槽 row 可以获取当前的数据 => v-for 遍历item -->
